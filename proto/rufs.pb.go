...
var file_rufs_proto_rawDesc = []byte{
	...
	0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x22, 0x24, 0x0a, 0x0e, 0x52, 0x65,
	...
	0x22, 0x36, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x75, 0x0a, 0x0f, 0x52, 0x65, 0x61, 0x64,
	...
	0x44, 0x0a, 0x10, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x0f,
	...
	0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0x75, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x1f, 0x5a, 0x1d,
...
var file_rufs_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_rufs_proto_goTypes = []interface{}{
	(*ConnectRequest)(nil),   // 0: ConnectRequest
	(*ConnectResponse)(nil),  // 1: ConnectResponse
	(*Peer)(nil),             // 2: Peer
	(*ReadDirRequest)(nil),   // 3: ReadDirRequest
	(*ReadDirResponse)(nil),  // 4: ReadDirResponse
	(*File)(nil),             // 5: File
	(*ReadFileRequest)(nil),  // 6: ReadFileRequest
	(*ReadFileResponse)(nil), // 7: ReadFileResponse
}
var file_rufs_proto_depIdxs = []int32{
	2, // 0: ConnectResponse.peers:type_name -> Peer
	5, // 1: ReadDirResponse.files:type_name -> File
	0, // 2: DiscoveryService.Connect:input_type -> ConnectRequest
	3, // 3: ContentService.ReadDir:input_type -> ReadDirRequest
	6, // 4: ContentService.ReadFile:input_type -> ReadFileRequest
	1, // 5: DiscoveryService.Connect:output_type -> ConnectResponse
	4, // 6: ContentService.ReadDir:output_type -> ReadDirResponse
	7, // 7: ContentService.ReadFile:output_type -> ReadFileResponse
